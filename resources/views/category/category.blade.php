                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            <i class="ki-duotone ki-magnifier fs-1 position-absolute ms-4"><span class="path1"></span><span class="path2"></span></i> <input type="text" data-kt-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar categoria" spellcheck="false" data-ms-editor="true">
                        </div>
                        <!--end::Search-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        <a type="button" href="{{route('category.add')}}" class="btn btn-light-success">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr class="odd">
                                <td class="text-center">
                                    <span class="fw-bold">Categoria 1</span>
                                </td>
                                <td class="text-center">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item  px-3">
                                            ...
                                            <a href="{{route('category.edit')}}" class="menu-link px-3">Editar</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
