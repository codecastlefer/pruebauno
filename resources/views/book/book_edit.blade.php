    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Editar libro</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Editar libro</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--begin::Input-->
                                <input type="text" name="text_input" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="Libro 1" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="text_input" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="Editorial 1" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                ...
                                <!--begin::Input-->
                                <input class="form-control" name="flatpickr_input" value="2024-12-4" placeholder="Elija una fecha" id="kt_flatpickr" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                ...
                                <!--begin::Input-->
                                <textarea name="textarea_input" class="form-control form-control-solid">Lorem ipsum dolor sit amet consectetur adipiscing elit aliquam, sociis leo venenatis lobortis facilisis penatibus nulla suspendisse, curae urna cras quisque primis nibh vulputate.</textarea>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                ...
                                <!--begin::Input-->
                                <input type="number" name="text_input" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="10" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
